    ...
    !function(e, t) {
      ...
      return function() {
        var __webpack_modules__ = {3312: function(e, t, n) {
          ...
          var z = n(3915), I = n.n(z), B = n(9405), D = n.n(B), F = n(5169), R = n.n(F), L = n(9548), P = n.n(L), H = n(6097), G = n.n(H), $ = n(6030), Y = n.n($), q = n(5004), Q = n.n(q), J = (n(9410), n(8609)), U = n.n(J);
          function W(e2) {
            var t2 = "luna-".concat(e2, "-");
            function n2(e3) {
          ...
          function X(e2) {
            ...
            var B2, D2 = d2 == "[object Array]", F2 = d2 == "[object Object]", R2 = d2 == "[object Number]", L2 = d2 == "[object RegExp]", P2 = d2 == "[object Symbol]", H2 = d2 == "[object Function]", G2 = d2 == "[object Boolean]";
            if (d2 == "[object String]")
              u2 = z2(te(e2));
            else if (L2)
          ...
          var Re = function(e2) {
            function t2(e3, n2) {
              var o2, i2, a2 = n2.compName, s2 = (arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}).theme, c2 = s2 === void 0 ? "light" : s2;
              return (0, r.A)(this, t2), (o2 = De(this, t2)).subComponents = [], o2.compName = a2, o2.c = Ne(a2), o2.options = {}, o2.container = e3, o2.$container = B()(e3), o2.$container.addClass(["luna-".concat(a2), o2.c("platform-".concat((i2 = Te()(), i2 === "os x" ? "mac" : i2)))]), o2.on("optionChange", function(e4, t3, n3) {
                var r2 = o2.c;
          ...
          var dt = function(e2) {
            function t2(e3) {
              var r2, i2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, a2 = i2.defaults, s2 = a2 === void 0 ? {} : a2, l2 = i2.inline, u2 = l2 !== void 0 && l2;
            ...
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{key: "show", value: function() {
              ...
              var s2 = e3.name;
              if (!s2)
                return Ke.error("You must specify a name for a tool");
              if (this._tools[s2])
                return Ke.warn("Tool ".concat(s2, " already exists"));
              var c2 = s2.replace(/\s+/g, "-");
              return this._$tools.prepend('<div id="'.concat(Ie(c2), '" class="').concat(Ie(c2 + " tool"), '"></div>')), e3.init(this._$tools.find(".".concat(Ie(c2), ".").concat(Ie("tool"))), this), e3.active = false, this._tools[s2] = e3, s2 === "settings" ? t3.append({id: s2, title: s2}) : t3.insert(t3.length - 1, {id: s2, title: s2}), this;
            }}, {key: "remove", value: function(e3) {
              var t3 = this._tools;
              if (!t3[e3])
              ...
              }), e3.separator().select(n2, "theme", "Theme", ["System preference"].concat((0, We.A)(B()(re.getThemes())))), this._inline || e3.range(n2, "transparency", "Transparency", {min: 0.2, max: 1, step: 0.01}).range(n2, "displaySize", "Display Size", {min: 40, max: 100, step: 1}), e3.button("Restore defaults and reload", function() {
              ...
              this._inline && (e3 = 100), Ze()(e3) && this._$el.css({height: e3 + "%"});
            }}, {key: "_initTpl", value: function() {
          ...
          }(v), Nt = ["log", "error", "info", "warn", "dir", "time", "timeLog", "timeEnd", "clear", "table", "assert", "count", "countReset", "debug", "group", "groupCollapsed", "groupEnd"], jt = n(9117), Mt = n.n(jt), zt = n(9464), It = n.n(zt), Bt = n(5902), Dt = n.n(Bt), Ft = n(4844), Rt = n.n(Ft), Lt = n(4983), Pt = n.n(Lt), Ht = n(15), Gt = n.n(Ht);
          function $t(e2, t2, n2) {
          ...
          var qt = function(e2) {
            function t2(e3, n2) {
              ...
              return (0, o.A)(this, t2), r2 = $t(this, t2), (0, c.A)(r2, "_copyRes", function() {
                ...
                It()(e4.data) || (t3 += "\nRequest Data\n\n", t3 += "".concat(e4.data, "\n")), It()(e4.reqHeaders) || (t3 += "\nRequest Headers\n\n", x()(e4.reqHeaders, function(e5, n3) {
                  ...
                  return t3 += "".concat(n3, ": ").concat(e5, "\n");
                })), e4.resTxt && (t3 += "\n".concat(e4.resTxt, "\n")), Rt()(t3), r2._devtools.notify("Copied", {icon: "success"});
            ...
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{key: "show", value: function(e3) {
              ...
              var t3 = "";
              e3.data && (t3 = '<pre class="'.concat(Ie("data"), '">').concat(Dt()(e3.data), "</pre>"));
              var n2 = "<tr><td>Empty</td></tr>";
              e3.reqHeaders && (n2 = Ae()(e3.reqHeaders, function(e4, t4) {
                return '<tr>\n          <td class="'.concat(Ie("key"), '">').concat(Dt()(t4), "</td>\n          <td>").concat(Dt()(e4), "</td>\n        </tr>");
              }).join(""));
          ...
          }(v), bn = n(2708), yn = n.n(bn), An = n(1167), wn = n.n(An), _n = n(5452), xn = n(96), kn = n.n(xn), Cn = n(896), Sn = n.n(Cn), En = n(438), On = n.n(En), Tn = n(6493), Nn = n.n(Tn), jn = n(6186), Mn = n.n(jn), zn = n(5241), In = n.n(zn), Bn = n(2208), Dn = n.n(Bn), Fn = n(5145), Rn = n.n(Fn);
          function Ln(e2) {
            ...
            return (0, r.A)(function e2(t2, n2) {
              ...
              e2.addEventListener = function(e3, n3, o2) {
                ...
                !function(e4, t4, n3) {
                  ...
                  B()(r2).length === 0 && delete e4.erudaEvents;
              ...
              It()(e2.attributes) || (a2 = Ae()(e2.attributes, function(e3) {
                ...
                return '<tr>\n          <td class="'.concat(Ie("attribute-name-color"), '">').concat(Dt()(t3), '</td>\n          <td class="').concat(Ie("string-color"), '">').concat(n3, "</td>\n        </tr>");
              ...
              if (It()(e2.styles))
                ...
                var c2 = Ae()(e2.styles, function(e3) {
                  ...
                  return n3 = Ae()(n3, function(e4, t4) {
                    return '<div class="'.concat(Ie("rule"), '"><span>').concat(Dt()(t4), "</span>: ").concat(e4, ";</div>");
                  }).join(""), '<div class="'.concat(Ie("style-rules"), '">\n          <div>').concat(Dt()(t3), " {</div>\n            ").concat(n3, "\n          <div>}</div>\n        </div>");
                }).join("");
              ...
              e2.listeners ? (d2 = Ae()(e2.listeners, function(e3, t3) {
                return e3 = Ae()(e3, function(e4) {
                  ...
                  return "<li ".concat(t4 ? 'class="'.concat(Ie("capture"), '"') : "", ">").concat(Dt()(n3), "</li>");
                }).join(""), '<div class="'.concat(Ie("listener"), '">\n          <div class="').concat(Ie("listener-type"), '">').concat(Dt()(t3), '</div>\n          <ul class="').concat(Ie("listener-content"), '">\n            ').concat(e3, "\n          </ul>\n        </div>");
              ...
              if (s2 && B()(s2).length !== 0 && (t2.listeners = s2), eo(a2))
                return t2;
              ...
              var e2 = this;
              this._observer = new (Dn())(function(t2) {
                x()(t2, function(t3) {
          ...
          var Wn = function(e2) {
            return Ae()(e2, function(e3) {
              ...
              return t2 = Dt()(t2), (n2 === "src" || n2 === "href") && !ot()(t2, "data") && (t2 = to(t2)), n2 === "style" && (t2 = Xn(t2)), {name: n2, value: t2};
            });
          }, Vn = /rgba?\((.*?)\)/g, Kn = /url\("?(.*?)"?\)/g;
          function Xn(e2) {
          ...
          var io = function(e2) {
            function t2() {
              ...
              return (0, o.A)(this, t2), e3 = oo(this, t2), (0, c.A)(e3, "_showDetail", function() {
                ...
                var t3 = e3._curNode;
                t3.nodeType === Node.ELEMENT_NODE ? Rt()(t3.outerHTML) : Rt()(t3.nodeValue), e3._container.notify("Copied", {icon: "success"});
          ...
          var mo = {monitor: "1.0.2", features: "2.0.0", timing: "2.0.1", code: "2.1.0", benchmark: "2.0.1", geolocation: "2.0.0", orientation: "2.0.0", touches: "2.1.0"}, go = n(961), bo = n.n(go);
          ...
          var wo = function(e2) {
            ...
            return (0, r.A)(function e2(t2, n2, r2, i2) {
              ...
              this._$container.on("click", Ie(".refresh-storage"), function() {
                ...
                Rt()(e2._getVal(t3)), n2.notify("Copied", {icon: "success"});
              }).on("click", Ie(".filter"), function() {
                st.A.prompt("Filter").then(function(t3) {
          ...
          var zo = function() {
            return (0, r.A)(function e2(t2, n2) {
              ...
              this._$container.on("click", Ie(".refresh-cookie"), function() {
                ...
                var n3 = e2._selectedItem;
                Rt()(e2._getVal(n3)), t2.notify("Copied", {icon: "success"});
              }).on("click", Ie(".filter"), function() {
                st.A.prompt("Filter").then(function(t3) {
            ...
            if (!n2) {
              if (Array.isArray(e2) || (n2 = function(e3, t3) {
                if (e3) {
                  ...
                  return n3 === "Object" && e3.constructor && (n3 = e3.constructor.name), n3 === "Map" || n3 === "Set" ? Array.from(e3) : n3 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? Bo(e3, t3) : void 0;
                }
          ...
          var Ro = function(e2) {
            function t2() {
              var e3;
              return (0, o.A)(this, t2), (e3 = Do(this, t2))._style = re(n(3815)), e3.name = "resources", e3._hideErudaSetting = false, e3._observeElement = true, e3;
            }
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{key: "init", value: function(e3, n2) {
              ...
              It()(e3) || (n2 = Ae()(e3, function(e4) {
                return e4 = Dt()(e4), '<li><a href="'.concat(e4, '" target="_blank" class="').concat(Ie("js-link"), '">').concat(e4, "</a></li>");
              }).join(""));
              ...
              It()(e3) || (n2 = Ae()(e3, function(e4) {
                return e4 = Dt()(e4), ' <li><a href="'.concat(e4, '" target="_blank" class="').concat(Ie("css-link"), '">').concat(e4, "</a></li>");
              }).join(""));
              ...
              var t3 = "<li>Empty</li>";
              It()(e3) || (t3 = Ae()(e3, function(e4) {
                return e4 = Dt()(e4), '<li><a href="'.concat(e4, '" target="_blank" class="').concat(Ie("iframe-link"), '">').concat(e4, "</a></li>");
              }).join(""));
              ...
              It()(e3) || (o2 = Ae()(e3, function(e4) {
                return '<li class="'.concat(Ie("image"), '">\n          <img src="').concat(Dt()(e4), '" data-exclude="true" class="').concat(Ie("img-link"), '"/>\n        </li>');
              }).join(""));
              ...
              var e3 = this;
              this._observer = new (Dn())(function(t3) {
                x()(t3, function(t4) {
          ...
          var Wo = function(e2) {
            ...
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{key: "init", value: function(e3, n2) {
              ...
              var t3 = "<ul>".concat(Ae()(e3, function(e4) {
                return '<li><h2 class="'.concat(Ie("title"), '">').concat(Dt()(e4.name), '<span class="').concat(Ie("icon-copy copy"), '"></span></h2><div class="').concat(Ie("content"), '">').concat(e4.val, "</div></li>");
              }).join(""), "</ul>");
              this._renderHtml(t3);
            }}, {key: "_bindEvent", value: function() {
              ...
              this._$el.on("click", Ie(".copy"), function() {
                ...
                Rt()("".concat(n2, ": ").concat(o2)), e3.notify("Copied", {icon: "success"});
              });
            }}, {key: "_renderHtml", value: function(e3) {
              e3 !== this._lastHtml && (this._lastHtml = e3, this._$el.html(e3));
            }}]);
          ...
          var rr = function(e2) {
            ...
            return (0, s.A)(t2, e2), (0, r.A)(t2, [{key: "init", value: function(e3, n2) {
              ...
              this._renderHtml('<div class="'.concat(Ie("image"), '">\n      <div class="').concat(Ie("breadcrumb"), '">').concat(Dt()(o2), '</div>\n      <div class="').concat(Ie("img-container"), '" data-exclude="true">\n        <img src="').concat(Dt()(o2), '">\n      </div>\n      <div class="').concat(Ie("img-info"), '">').concat(Dt()(t3), " \xD7 ").concat(Dt()(n2), "</div>\n    </div>"));
              ...
              new Vo.A(this._$el.find(".eruda-json").get(0), {unenumerable: true, accessGetter: true, prototype: false}).set(e3);
              ...
              this._renderHtml('<iframe src="'.concat(Dt()(this._data.val), '"></iframe>'));
            }}, {key: "_renderHtml", value: function(e3) {
              var t3 = this;
            ...
            var e2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, t2 = e2.container, n2 = e2.tool, o2 = e2.autoScale, r2 = o2 === void 0 || o2, i2 = e2.useShadowDom, a2 = i2 === void 0 || i2, s2 = e2.inline, c2 = s2 !== void 0 && s2, l2 = e2.defaults, u2 = l2 === void 0 ? {} : l2;
          ...
          }, _isInit: false, version: "3.2.1", util: {isErudaEl: ze, evalCss: re, isDarkTheme: function(e2) {
            ...
            this._devTools = new dt(this._$el, {defaults: e2, inline: t2});
          }, _initStyle: function() {
          ...
          t.clear = function() {
            ...
            if (!p2 || o2 || B(l2) || a2.push({name: "__proto__", configurable: true, enumerable: false, isOwn: (0, A.default)(l2, "__proto__"), value: E(p2, {self: f2}), writable: false}), t2)
              return {result: a2};
            var M2 = [];
            if (p2 && !B(l2) && M2.push({name: "[[Prototype]]", value: E(p2, {self: f2})}), (0, u.default)(l2) || (0, d.default)(l2)) {
              var z2 = function(e3) {
          ...
          var h = function(e2) {
            ...
            function i2(e3, t3) {
              ...
              for (var B = 0; B < t3.length; ++B) {
                var D = t3[B];
                switch ((x = D[0]) !== "S" && x !== "s" && x !== "C" && x !== "c" && (C = null, S = null), x !== "T" && x !== "t" && x !== "Q" && x !== "q" && (E = null, O = null), x) {
                  case "m":
                  case "M":
                    x === "m" ? (p2 += D[1], m2 += D[2]) : (p2 = D[1], m2 = D[2]), x !== "M" && z || (z = {x: p2, y: m2}), e3.moveTo(p2, m2);
                    break;
                  case "l":
                  ...
                  case "a":
                  case "A":
                    x === "a" ? (p2 += D[6], m2 += D[7]) : (p2 = D[6], m2 = D[7]), y = D[1], A = D[2], c2 = D[3] * Math.PI / 180, r3 = !!D[4], i3 = !!D[5], a2 = {x: p2, y: m2}, d(s2 = {x: (I.x - a2.x) / 2, y: (I.y - a2.y) / 2}, -c2), (l2 = s2.x * s2.x / (y * y) + s2.y * s2.y / (A * A)) > 1 && (y *= l2 = Math.sqrt(l2), A *= l2), u2 = y * y * A * A, h2 = y * y * s2.y * s2.y + A * A * s2.x * s2.x, f(k = {x: y * s2.y / A, y: -A * s2.x / y}, i3 !== r3 ? Math.sqrt((u2 - h2) / h2) || 0 : -Math.sqrt((u2 - h2) / h2) || 0), o3 = Math.atan2((s2.y - k.y) / A, (s2.x - k.x) / y), n3 = Math.atan2(-(s2.y + k.y) / A, -(s2.x + k.x) / y), d(k, c2), N = k, j = (a2.x + I.x) / 2, M = (a2.y + I.y) / 2, N.x += j, N.y += M, e3.save(), e3.translate(k.x, k.y), e3.rotate(c2), e3.scale(y, A), e3.arc(0, 0, 1, o3, n3, !i3), e3.restore();
                    break;
                  case "C":
                  ...
                  case "c":
                    ...
                    break;
                  case "S":
                    C !== null && S !== null || (C = p2, S = m2), e3.bezierCurveTo(2 * p2 - C, 2 * m2 - S, D[1], D[2], D[3], D[4]), C = D[1], S = D[2], p2 = D[3], m2 = D[4];
                    break;
                  case "s":
                    C !== null && S !== null || (C = p2, S = m2), e3.bezierCurveTo(2 * p2 - C, 2 * m2 - S, D[1] + p2, D[2] + m2, D[3] + p2, D[4] + m2), C = D[1] + p2, S = D[2] + m2, p2 += D[3], m2 += D[4];
                    break;
                  case "Q":
                  ...
                  case "q":
                    ...
                    break;
                  case "T":
                    E !== null && O !== null || (E = p2, O = m2), E = 2 * p2 - E, O = 2 * m2 - O, p2 = D[1], m2 = D[2], e3.quadraticCurveTo(E, O, p2, m2);
                    break;
                  case "t":
                    E !== null && O !== null || (E = p2, O = m2), E = 2 * p2 - E, O = 2 * m2 - O, p2 += D[1], m2 += D[2], e3.quadraticCurveTo(E, O, p2, m2);
                    break;
